...
capture = cv2.VideoCapture('../data/girls.mp4')

frame_width = int(capture.get(3))
frame_height = int(capture.get(4))

# output = cv2.VideoWriter('output.mp4', cv2.VideoWriter.fourcc('M','J','P','Q'),10,(frame_width,frame_height))
fourcc = cv2.VideoWriter_fourcc(*"mp4v")

output = cv2.VideoWriter('output.mp4', fourcc, 30, (frame_width, frame_height), True)
